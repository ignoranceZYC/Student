...
int test()
{
    ...
    //真正建立mysql链接
    char  host_name[1024] = "39.106.76.148";		//mysql服务器的IP
    char  user_name[1024] = "root";				//用户名
    char  user_password[1024] = "123";		///密码		需要改为自己的密码
    char  server_name[1024] = "student";			///数据库名	需要改为自己的数据库名
    ...
    if (!mysql_real_connect(&mysql, "39.106.76.148", "root",
        "123", "student", 3306, NULL, 0)) {
        puts("数据库连接失败");
